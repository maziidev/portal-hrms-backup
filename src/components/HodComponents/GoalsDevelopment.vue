        ...
        <div>
          ...
          <div class="my-3">
            <input
              ...
              class="w-full bg-[rgba(161,161,170,0.09)] outline-none h-[47px] border-0 px-[12px] py-[15px] font-normal text-[14px] leading-[120%] tracking-[-2%] text-[rgba(161,161,170,1)]"
            />
          </div>
        </div>
        <div>
...
const emit = defineEmits([
  "closeGoalsDevelopment",
  "openSummarySubmission",

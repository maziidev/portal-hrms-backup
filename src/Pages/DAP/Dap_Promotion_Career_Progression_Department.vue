<template>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-[30px] items-center">
    <div class="">
      <div class="top">
        <h2
          class="text-[rgba(27,37,89,1)] text-left relative text-[20px] tracking-[-2%] leading-[120%] font-bold"
        >
    ...
    <div class="">
      <div class="top flex justify-between w-full gap-[10px] items-center">
        <h2
        ...
        >
          <button
            ...
            @click="switchPromotionTrend(promotion_rate.name.toLowerCase())"
  ...
  <form class="w-full mb-5">
    ...
    >
      ...
      >
        <h2
          class="font-bold text-(--sec-text) w-[200px] text-[20px] leading-[120%] tracking-[-2%]"
        >
          Promotion Requests
        </h2>

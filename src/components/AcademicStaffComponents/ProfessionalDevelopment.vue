  ...
  >
    ...
    >
      ...
      <div class="personal_information flex flex-col gap-[10px]">
        <div>
          <n-form-item
            label="Trainings / Workshops Attended"
            path="committees_served"
          >
            <n-input
              type="text"
        ...
        <div>
          <n-form-item label="Future Goals" path="future_goals">
            <n-input
              type="textarea"
...
const emit = defineEmits([
  ...
  "closeProfessionalDevelopment",
  "openSummaryAndSubmission",
]);
function closeModal() {
  emit("closeProfessionalDevelopment");
}

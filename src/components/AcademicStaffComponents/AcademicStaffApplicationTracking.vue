...
const emit = defineEmits(["closeAcademicStaffApplicationTrackingForPromotion"]);

function closeModal() {
  emit("closeAcademicStaffApplicationTrackingForPromotion");
}
...
const columns = [
  ...
  { title: "Actioned By ", key: "actioned_by " },
  { title: "Actioned By ", key: "actioned_by " },

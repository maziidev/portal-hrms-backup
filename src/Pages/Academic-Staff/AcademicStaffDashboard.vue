    ...
    <div class="dashboard w-full min-h-screen">
      ...
      <main class="lg:ml-[270px] md:ml-[270px] ml-[0px] min-w-screen relative">
        <div class="header">
          ...
          >
            <div class="w-[70%]">
              <h2 class="bc mb-[7px]">Welcome back, Dr. Adaobi Emmanuel</h2>
              <h5 class="sbc">Department of Biological Sciences</h5>
            </div>
        ...
        <div class="main px-[25px] mt-[50px] flex flex-col gap-[40px]">
          ...
          >
            ...
            >
              ...
              >
                <h4 class="text-[rgba(141,193,255,1)] mbs">Appraisal Status</h4>
                <div class="flex justify-between items-center gap-3">
                  <div class="balance">
                    <h2
                      class="text-[rgba(255,255,255,1)] text-[14px] font-[500] leading-[120%] tracking-[-2%]"
                    >
                      2024/2025 Appraisal: Open – Due in 14 days
                    </h2>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div class="flex flex-col gap-[30px]">
                ...
                <div class="flex justify-between items-center gap-[10px]">
                  <div
                    class="flex justify-center gap-[10px] items-center w-full"
                  >
                    <p
                      class="text-[rgba(163,174,208,1)] font-[500] text-[12px] leading-[120%] tracking-[-2%]"
                    >
                      Stay informed on every faculty update and HR memo
                    </p>
                  </div>
                </div>
              </div>
...
const labels = ref(["2022", "2023", "2024"]);
const colors = ["rgba(35,136,255,1)", "rgba(43,7,237,1)", "rgba(6,108,229,1)"];

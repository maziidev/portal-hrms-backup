<template>
  <div class="bg-white px-8 py-6 rounded-2xl border border-gray-100 shadow-sm h-full">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
      <div>
        <h2 class="text-[10px] font-black text-gray-400 uppercase tracking-[0.3em]">Staff Departments</h2>
        <h3 class="text-lg font-black text-orbit-bg italic">Promotion Rate By Department</h3>
      </div>
...
// Dummy Data Sets
const dataSets = {
  2023: [45, 52, 38, 65, 48, 55],
  2024: [60, 75, 50, 80, 70, 62],
  2025: [82, 60, 55, 70, 70, 82]
};
...
const chartOptions = ref({
  ...
  legend: { show: false },
  xaxis: {
    categories: ["Computer Science", "Physics", "Mathematics", "Chemistry", "Statistic", "Geo. Physics"],

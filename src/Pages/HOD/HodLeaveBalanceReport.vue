        ...
        >
          ...
          <div class="flex flex-col gap-[25px]">
            ...
            <li>
              <router-link
                to="/hod/appraisal"
                class="text-(--pri-text) font-bold text-[14px] tracking-[-2%] leading-[120%] flex items-center gap-2"
          ...
          style:
            row.is_active == "Ongoing"
              ...
              : row.is_active == "Updated"
                ? "rounded-[22.5px] text-[rgba(35,136,255,1)] px font-bold text-[14px] leading-[100%] tracking-[0%] px-[20px] py-[10px] bg-[rgba(78,159,255,0.2)]"
                : "rounded-[22.5px] text-[rgba(251,188,4,1)] px font-bold text-[14px] leading-[100%] tracking-[0%] px-[20px] py-[10px] bg-[rgba(251,188,4,0.2)]",
        },
        row.is_active,
      );

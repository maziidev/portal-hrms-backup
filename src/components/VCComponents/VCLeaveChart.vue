  ...
  <div class="bg-white px-8 py-6 rounded-2xl border border-gray-100 shadow-sm h-full">
    <div class="flex items-center justify-between mb-6">
      <div>
        ...
        <h3 class="text-lg font-black text-orbit-bg italic">Leave Utilization</h3>
      </div>
      <span class="text-[10px] font-bold bg-blue-50 text-orbit-wa px-3 py-1 rounded-full uppercase">Academy</span>
    </div>

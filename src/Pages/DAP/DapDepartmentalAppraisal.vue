...
const columns = [
  ...
  { title: "Submitted On", key: "submitted_on" },
        ...
        "span",
        {
          style:
            row.is_active == "Approved"
              ...
              ? "rounded-[22.5px] text-[rgba(107,114,128,1)] px font-[700] text-[14px] leading-[100%] tracking-[0%] px-[20px] py-[10px] bg-[rgba(107,114,128,0.2)] w-[120px]"

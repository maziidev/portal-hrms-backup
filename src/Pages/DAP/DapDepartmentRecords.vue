    ...
    <div class="dashboard w-full min-h-screen">
      ...
      <main class="lg:ml-[270px] md:ml-[270px] ml-[0px] min-w-screen relative">
        <div class="header">
          ...
          >
            <div class="w-[70%]">
              <h2 class="bc mb-[7px]">Department Records</h2>
            </div>
...
const columns = [
  ...
  { title: "Non-Academic", key: "non_academic" },
  { title: "Active Appraisals", key: "active_appraisals" },
  { title: "Pending Promotions", key: "pending_promotions" },
];
const pagination = {
  // pageSize:10,
  showSizePicker: true,

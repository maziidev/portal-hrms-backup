          ...
          style:
            row.is_active == "Approved"
              ...
              : row.is_active == "Active"
                ? "rounded-[22.5px] text-[rgba(35,136,255,1)] px font-bold text-[14px] leading-[100%] tracking-[0%] px-[20px] py-[10px] bg-[rgba(78,159,255,0.2)] w-[120px]"
                : "rounded-[22.5px] text-[rgba(251,188,4,1)] px font-bold text-[14px] leading-[100%] tracking-[0%] px-[20px] py-[10px] bg-[rgba(251,188,4,0.25)]",
        },
        row.is_active,
      );
    },
